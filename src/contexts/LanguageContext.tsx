...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "process.step1.desc": "Todo comienza con tu aplicación. Analizamos personalmente tu perfil deportivo y académico para darte una respuesta real sobre tus posibilidades de beca antes de dar el siguiente paso.",
    "process.step2.title": "Admisión y Plan Personalizado",
    "process.step2.desc": "Al entrar en FutbolU, diseñamos tu hoja de ruta a medida. Se te asignará un agente personal y nuestro equipo de edición empezará a trabajar en tu perfil y en un video de mejores jugadas de alto impacto.",
    ...
    "process.step4.desc": "Nosotros damos la cara por ti. Contactamos directamente con los coaches en EE.UU., presentamos tu talento y negociamos las mejores condiciones de beca posibles en tu nombre.",
    "process.step5.title": "Decisión y Trámites de Admisión",
    "process.step5.desc": "Te acompañamos en la elección final de tu universidad. No estás solo en el papeleo: realizamos juntos todos los trámites de admisión para que cada documento sea perfecto.",
    "process.step6.title": "Visado y Tu Nueva Vida en USA",
    "process.step6.desc": "Te guiamos en la obtención de tu Visa F-1 y preparamos tu llegada al campus. Una vez allí, seguimos a tu lado: FutbolU te acompaña durante los 4 años de carrera, apoyándote en cada paso de tu vida universitaria.",
    "process.phase": "Fase",
  ...
  en: {
    ...
    "process.step4.desc": "We go to bat for you. We contact coaches in the U.S. directly, present your talent, and negotiate the best possible scholarship terms on your behalf.",
